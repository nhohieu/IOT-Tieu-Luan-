...
PARKING_SLOTS = [
    np.array([(np.int32(217), np.int32(80)), (np.int32(218), np.int32(320)), (np.int32(354), np.int32(320)), (np.int32(353), np.int32(79))], np.int32),  
]

IMAGE_TEST_PATH = "assets/wrongcar1.jpg"
DISPLAY_SCALE = 1
